...
All project materials (including the data, analysis code, protocols, interview schedules) will be hosted on the OSF. Almost everything will be hosted publicly. Only the audio recordings, non-anonymised versions of transcripts and transcripts from respondents who specifically request their data not to be shared will remain private. 
