...
We will conduct a feasibility study to inform a pilot RCT to assess the impacts of partnerships. 
Currently we do not know how feasible or acceptable partnerships are to their stakeholders nor how a RCT of their impacts should be designed and conducted.
Given these unknowns a feasibility study is required to inform a future pilot.

A RCT of RRs is likely to be more immediately feasible than a RCT of partnerships since there are far more RR journals. 
However, we have chosen to focus on the impacts of partnerships rather than RRs because [?] we believe we have access to funder personnel that other researchers may not. 
